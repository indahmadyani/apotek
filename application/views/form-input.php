...
<div id="container">
	...
	<div id="body">
		...
		<form action="<?php echo site_url('welcome/insert') ?>" method="POST">
			Kode obat<br>
			<input type="text" name="kodeobat" /> <br>
			Produsen Obat <br>
			<input type="text" name="prodobat" /><br>
			Expired Obat<br>
			<input type="text" name="expaobat" /> <br>
			Nama Obat<br>
			<input type="text" name="namaobat" /> <br>
			Harga Obat<br>
			<input type="text" name="hargaobat" /> <br>
			Harga Beli <br>
			<input type="text" name="hargabeli" /><br>
			Stok Obat<br>
			<input type="text" name="stokobat" /> <br>
			Jenis Obat<br>
			<input type="text" name="jenisobat" /> <br><br>
			Kode Satuan
